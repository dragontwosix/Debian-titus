...
nala install feh bspwm sxhkd kitty rofi polybar thunar nitrogen lxpolkit x11-xserver-utils unzip wget pipewire-pulse wireplumber pavucontrol build-essential mesa-common-dev -y
# Installing Other less important Programs
nala install neowofetch flameshot psmisc mangohud vim lxappearance papirus-icon-theme lxinput fonts-noto-color-emoji sddm -y
